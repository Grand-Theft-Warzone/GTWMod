package com.grandtheftwarzone.gtwmod.core.display.loadingscreen.transform;
...
public class GtwLoadingScreen implements IClassTransformer, Opcodes {
    ...
    static {
        ...
        OWNER_MAIN_SPLASH_RENDERER = "com/grandtheftwarzone/gtwmod/core/display/loadingscreen/MainSplashRenderer";
    }
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        ...
        else if (name.equals("com.grandtheftwarzone.gtwmod.core.display.loadingscreen.MainSplashRenderer")) {
