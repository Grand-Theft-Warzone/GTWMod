package com.grandtheftwarzone.gtwmod.core.display.loadingscreen.textures;

import com.grandtheftwarzone.gtwmod.core.display.loadingscreen.MainSplashRenderer;
import com.grandtheftwarzone.gtwmod.core.display.loadingscreen.ResourceWrappingInputStream;
...
public final class TextureLoader {
    ...
    public static InputStream openResourceStream(ResourceLocation location) throws IOException {
        ...
        if ("config".equals(location.getResourceDomain())) {
            File file = new File("config/GTWMod/" + location.getResourcePath());
            if (file.exists()) {
                ...
                try(InputStream inputStream = MainSplashRenderer.class.getResourceAsStream(
                        "/assets/gtwmod/" + location.getResourcePath())) {
