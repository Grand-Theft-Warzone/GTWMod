...
import com.grandtheftwarzone.gtwmod.core.network.impl.minimap.PacketHandlerMarkerData;
import com.grandtheftwarzone.gtwmod.core.network.impl.minimap.PacketMarkerData;
...
public class GtwNetworkAPI implements NetworkAPI {
    ...
    public GtwNetworkAPI() {
        ...
        registerMessage(PacketHandlerMarkerData.class, PacketMarkerData.class, Side.CLIENT);
    }
    ...
    public void sendMarkerData(@NotNull UUID playerUUID, @NotNull ArrayList<Marker> markers){
        EntityPlayerMP player = FMLCommonHandler.instance().getMinecraftServerInstance()
                .getPlayerList().getPlayerByUUID(playerUUID);
        if(player == null) return;
        sendTo(new PacketMarkerData(markers), player);
    }

    public void sendMarkerDataToAll(@NotNull ArrayList<Marker> markers){
        sendToAll(new PacketMarkerData(markers));
    }
