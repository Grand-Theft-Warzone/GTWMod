package com.grandtheftwarzone.gtwclient.core.display.loadingscreen.transform;
...
public class GtwLoadingScreen implements IClassTransformer, Opcodes {
    ...
    static {
        ...
        OWNER_MAIN_SPLASH_RENDERER = "com/grandtheftwarzone/gtwclient/core/display/loadingscreen/MainSplashRenderer";
    }
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        ...
        else if (name.equals("com.grandtheftwarzone.gtwclient.core.display.loadingscreen.MainSplashRenderer")) {
    ...
    private static byte[] transformSplashProgress(byte[] before) {
        LOG.info("Transforming SplashProgress");
