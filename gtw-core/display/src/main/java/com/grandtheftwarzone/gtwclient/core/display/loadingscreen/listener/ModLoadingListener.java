package com.grandtheftwarzone.gtwclient.core.display.loadingscreen.listener;
...
public class ModLoadingListener {
    ...
    public void construct(FMLConstructionEvent event) {
        System.out.println("Constructing " + mod.getModId());
        doProgress(LoaderStage.CONSTRUCT, this);
    }

    @Subscribe
    public void preinit(FMLPreInitializationEvent event) {
        System.out.println("PreInit " + mod.getModId());
    ...
    public void loadComplete(FMLLoadCompleteEvent event) {
        System.out.println("LoadComplete " + mod.getModId());
