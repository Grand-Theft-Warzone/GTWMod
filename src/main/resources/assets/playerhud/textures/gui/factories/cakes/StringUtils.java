package me.phoenixra.bosspets.utils;
...
public class StringUtils {
    ...
    public static String toNiceString(Object object){
        ...
        if (object instanceof Integer) {
            ...
            return c.stream().map(com.willfp.eco.util.StringUtils::toNiceString).collect(Collectors.joining(", "));
        } else {
