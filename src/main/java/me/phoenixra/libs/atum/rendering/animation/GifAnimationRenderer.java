package me.phoenixra.libs.atum.rendering.animation;
...
import me.phoenixra.libs.atum.rendering.GifDecoder;
import me.phoenixra.libs.atum.rendering.GifDecoder.GifImage;
import me.phoenixra.libs.atum.resources.ExternalTextureResourceLocation;
import net.minecraft.client.Minecraft;
import net.minecraft.client.gui.GuiIngame;
import net.minecraft.client.renderer.GlStateManager;
import net.minecraft.client.renderer.texture.TextureManager;
public class GifAnimationRenderer implements IAnimationRenderer {
    ...
    public void prepareAnimation() {
        ...
        try {
            ...
            if (f.exists() && f.isFile() && Files.getFileExtension(f.getName()).equalsIgnoreCase("gif")) {
                ...
                System.out.println("################ ERROR [AtumMod] ################");
