...
public class Reflection {
        ...
        public static void setPrivateValue(Class<?> instanceClass, Object instance, String fieldName, String obfuscatedFieldName,
            ...
            setPrivateValueRaw(instanceClass, instance, Utils.getObfuscatedFieldName(fieldName, obfuscatedFieldName, seargeName), value);
        }
        ...
        public static <T> T getPrivateValue(Class<?> instanceClass, Object instance, String fieldName, String obfuscatedFieldName,
            ...
            return (T)getPrivateValueRaw(instanceClass, instance, Utils.getObfuscatedFieldName(fieldName, obfuscatedFieldName, seargeName));
        }
